...
public class NeuralNet2 {
    ...
    //初始化
    public NeuralNet2(int inputCount, int hidderCount, int outputCount){

        inputLayer=new double[inputCount];
        hiddenLayerWeight=new double[hidderCount][inputLayer.length];
    ...
    public static void main(String[] args){
        NeuralNet2 neuralNet=new NeuralNet2(2,3,1);
